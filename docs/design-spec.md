...
1. **Header** — 🦍 emoji (large), title "ゴッリッラ翻訳", subtitle "GORILLA TRANSLATOR"
...
<head>
  ...
  <title>ゴッリッラ翻訳 — Gorilla Translator</title>
